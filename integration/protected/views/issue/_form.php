...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'status_id', $model->getStatuOptions()); ?>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'owner_id'); ?>
                <?php echo $form->dropDownList($model,"owner_id", CHtml::listData($this->getProject()->users, 'id', 'username')) ?>
