...
--
-- Host: localhost
-- Generation Time: Jun 21, 2012 at 05:46 AM
...
-- Functions
--
CREATE DEFINER=`root`@`localhost` FUNCTION `da_anonymize`(inputChar VARCHAR(255), reversible TINYINT) RETURNS varchar(255) CHARSET latin1
BEGIN
...
CREATE DEFINER=`root`@`localhost` FUNCTION `da_reverse`(inputChar VARCHAR(255)) RETURNS varchar(255) CHARSET latin1
BEGIN
                      DECLARE tmpStr VARCHAR(255);
                      DECLARE tmpKey VARCHAR(255) DEFAULT "NCHADS_DA" ;
