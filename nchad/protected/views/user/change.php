...
<div class="form round" id="login">
  <h2> Fill in the following field </h2>
  <p class="note">Fields with <span class="required">*</span> are required.</p>
  
  <div class="row" >
    <?php echo $form->labelEx($model, "old_password"); ?>
    <?php echo $form->passwordField($model, "old_password", array("class"=>"login-input")) ; ?>
  ...
  <div class="row" >
    ...
    <?php echo $form->passwordField($model, "password_repeat" , array("class"=>"login-input") ) ; ?>
